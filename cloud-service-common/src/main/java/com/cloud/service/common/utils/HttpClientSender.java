...
public class HttpClientSender {
    ...
    public static String sendHttpPost(String url, String sendData) throws IOException {
        return sendHttpPost(url, "", sendData, null);
    }


    public static String sendHttpPost(String host, String method, String sendData, Map<String, String> headers) throws IOException {

        String requestUrl = host + method;

        Map<String, Object> response = request("POST", requestUrl, sendData, headers);
