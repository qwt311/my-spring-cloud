...
import com.cloud.server.client.common.request.auth.AuthPersonEntity;
    ...
    public ApiResult authPerson(@RequestBody AuthPersonEntity authPersonEntity){
        ...
        try{
            ...
            if(!authPersonal.isFlag()){
                ...
                return ApiResult.buildApiResult(CommonCodeEnum.SUCCESS.success(),CommonCodeEnum.SUCCESS.code(),
                        "鉴权通过",body);
            }
